  ...
  try {
    ...
    var updateProduct = await prisma.products.update({
      ...
      data: {
        ...
        image1: imageName1! != null ? `${process.env.APP_URL}/static/attachment/product/images/${imageName1}` : product?.image1,
        image2: imageName2! != null ? `${process.env.APP_URL}/static/attachment/product/images/${imageName2}` : product?.image2,
        image3: imageName3! != null ? `${process.env.APP_URL}/static/attachment/product/images/${imageName3}` : product?.image3,
        image4: imageName4! != null ? `${process.env.APP_URL}/static/attachment/product/images/${imageName4}` : product?.image4,
        image5: imageName5! != null ? `${process.env.APP_URL}/static/attachment/product/images/${imageName5}` : product?.image5,
